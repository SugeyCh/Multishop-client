    ...
    <>
      <main className="main">
        <form action="">
          ...
          <button
            type="button"
            className="text-white bg-gray-500 hover:bg-gray-500 focus:outline-none focus:ring-4 focus:ring-gray-500 font-medium rounded-lg w-50 text-sm px-5 py-2.5 text-center me-2 mb-4 mt-4 dark:bg-gray-500 dark:hover:bg-gray-500 dark:focus:ring-gray-500"
            onClick={ postProd }
          >
            Registrar
          </button>
